...
export class AppController {
  ...
  @ApiResponse({
    status : 200,
    description : "opaque token generated", schema :{
      type : 'array',
      items : {
        type : 'object',
        properties : {
  ...
  @ApiResponse({
    status : 400,
    description : 'Invalid credentials, username and password missing in body',schema  : {
      type : 'array',
      items : {
        type : 'object',
        properties : {
  ...
  @ApiResponse({
    status : 401,
    description : 'Invalid resource type, send the resource in xyz:abc format',schema  : {
      type : 'array',
      items : {
        type : 'object',
        properties : {
  ...
  @ApiResponse({
    status : 200,
    description : 'opaque token verified', schema :{
      type : 'array',
      items : {
        type : 'object',
        properties : {
  ...
  @ApiResponse({
    status : 401,
    description : 'No token is given',schema  : {
      type : 'array',
      items : {
        type : 'object',
        properties : {
  ...
  @ApiResponse({
    status : 200,
    description : 'jwt token verified', schema :{
      type : 'array',
      items : {
        type : 'object',
        properties : {
  ...
  @ApiResponse({
    status : 400,
    description : 'Invalid fields',schema  : {
      type : 'array',
      items : {
        type : 'object',
        properties : {
  ...
  @ApiResponse({
    status : 401,
    description : 'Duplicate entry',schema  : {
      type : 'array',
      items : {
        type : 'object',
        properties : {
