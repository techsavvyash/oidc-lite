...
describe('ApplicationRolesService', () => {
  ...
  describe('createRole', () => {
    ...
    it('should create a new role successfully', async () => {
      ...
      jest
        .spyOn(prismaService.applicationRole, 'create')
  ...
  describe('updateRole', () => {
    ...
    const mockApplicationRes = {
      ...
      active: true,
      data: 'data',
      logo_uri: 'http://application-logo-uri',
      idTokenSigningKeysId: 'token-signing-id',
      createdAt: new Date(),
      updatedAt: new Date(),
      name: 'name',
    ...
    it('should update role successfully', async () => {
      ...
      jest
        ...
        .mockResolvedValue(mockApplicationRes);
      jest
        .spyOn(prismaService.applicationRole, 'update')
        .mockResolvedValue(mockApplicationResponse);
    ...
    it('should throw BadRequestException if no application Id is provided', async () => {
      ...
      await expect(
        service.updateRole(null, mockRoleId, mockUpdateRoleDto, mockHeaders),
      ).rejects.toThrow(BadRequestException);
    });
  ...
  describe('deleteRole', () => {
    ...
    it('should delete role successfully', async () => {
      ...
      jest
        ...
        .mockResolvedValue(mockApplicationRes);
      jest
        .spyOn(prismaService.applicationRole, 'delete')
        .mockResolvedValue(mockApplicationResponse);
