...
describe('ApplicationScopesService', () => {
  ...
  describe('createScope', () => {
    ...
    it('should throw BadRequestException if no data is provided', async () => {
      ...
      await expect(
        service.createScope(null, mockApplicationId, mockScopeId, mockHeaders),
    ...
    it('should throw BadRequestException if no application ID is provided', async () => {
      ...
      await expect(
        service.createScope(mockScopeDto, null, mockScopeId, mockHeaders),
      ).rejects.toThrow(BadRequestException);
    });
    ...
    it('should return data.id when data.id is present', async () => {
      ...
      jest
        ...
        .mockResolvedValue(mockApplicationRes);
      jest
        .spyOn(prismaService.applicationOauthScope, 'create')
    ...
    it('should return internal server error creating a new Scope', async () => {
      ...
      jest
        ...
        .mockImplementation(() => {
          throw new Error(
            'Unique constraint failed on the fields: (`name`, `applicationsId`)',
          );
        });
      await expect(
        service.createScope(
  ...
  describe('updateScope', () => {
    ...
    it('should throw BadRequestException if no data is provided', async () => {
      ...
      await expect(
        service.updateScope(mockApplicationId, mockScopeId, null, mockHeaders),
      ).rejects.toThrow(BadRequestException);
    });
    ...
    it('should throw BadRequestException if no id is provided', async () => {
      ...
      await expect(
        service.updateScope(null, mockScopeId, mockUpdateScopeDto, mockHeaders),
      ).rejects.toThrow(BadRequestException);
    });
    ...
    it('should throw InternalServerException', async () => {
      ...
      jest
        ...
        .mockResolvedValue(mockApplicationRes);
      jest
        .spyOn(prismaService.applicationOauthScope, 'findUnique')
        .mockResolvedValue(null);
    ...
    it('should use defaultConsentDetail from data if provided', async () => {
      ...
      jest
        .spyOn(prismaService.applicationOauthScope, 'findUnique')
        .mockResolvedValue(oldScope);

      const updatedScope = {
        ...oldScope,
        ...mockUpdateScopeDto,
        description: JSON.stringify(mockUpdateScopeDto),
      };

      jest
        .spyOn(prismaService.applicationOauthScope, 'update')
        .mockResolvedValue(updatedScope);

      const response = await service.updateScope(
        mockApplicationId,
        mockScopeId,
        mockUpdateScopeDto,
        mockHeaders,
    ...
    it('should use defaultConsentMessage from data if provided', async () => {
      ...
      const updateData: UpdateScopeDto = {
        defaultConsentMessage: 'newMessage',
      };
  ...
  describe('deleteScope', () => {
    ...
    it('should throw UnauthorizedException if route validation fails', async () => {
      ...
      await expect(
        service.deleteScope(mockApplicationId, mockScopeId, mockHeaders),
      ).rejects.toThrow(UnauthorizedException);
    });
    ...
    it('should throw BadRequestException if no application id is found', async () => {
      ...
      await expect(
        service.deleteScope(null, mockScopeId, mockHeaders),
      ).rejects.toThrow(BadRequestException);
    });
    ...
    it('should throw BadRequestException if no scopeId is provided', async () => {
      ...
      await expect(
        service.deleteScope('id', null, mockHeaders),
      ).rejects.toThrow(BadRequestException);
    });
    ...
    it('should handle error while deleting scope', async () => {
      ...
      jest
        ...
        .mockResolvedValue(mockApplicationRes);
      jest
        .spyOn(prismaService.applicationOauthScope, 'delete')
        .mockImplementation(() => {
          throw new Error('Error');
        });

      await expect(service.deleteScope('id', 'scopeId', {})).rejects.toThrow(
        InternalServerErrorException,
      );
    });
